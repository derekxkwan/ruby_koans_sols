...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject is basically reduce/fold as in lisps
  end
  ...
  # you create a block with its own scope with a variable file instead of creating a file variable that exists in a larger (unneeded) scope
end
